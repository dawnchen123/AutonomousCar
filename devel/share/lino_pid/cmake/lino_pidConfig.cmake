...
if("TRUE" STREQUAL "TRUE")
  set(lino_pid_SOURCE_PREFIX /home/nvidia/linorobot_ws/src/lino_pid)
  set(lino_pid_DEVEL_PREFIX /home/nvidia/linorobot_ws/devel)
  set(lino_pid_INSTALL_PREFIX "")
  set(lino_pid_PREFIX ${lino_pid_DEVEL_PREFIX})
else()
  set(lino_pid_SOURCE_PREFIX "")
  set(lino_pid_DEVEL_PREFIX "")
  set(lino_pid_INSTALL_PREFIX /home/nvidia/linorobot_ws/install)
...
if(NOT "/home/nvidia/linorobot_ws/devel/include;/home/nvidia/linorobot_ws/src/lino_pid/include " STREQUAL " ")
  set(lino_pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/linorobot_ws/devel/include;/home/nvidia/linorobot_ws/src/lino_pid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lino_pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/linorobot_ws/src/lino_pid/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/linorobot_ws/devel/lib;/home/nvidia/mrobot_v2/mrobot/devel/lib;/home/nvidia/velodyne16/devel/lib;/home/nvidia/rplidar/devel/lib;/home/nvidia/turbot/devel/lib;/home/nvidia/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
