...
#define WHEEL_DIAMETER 0.32       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.53  // distance between left and right wheels
#define FR_WHEELS_DISTANCE 0.46   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
#define MAX_STEERING_ANGLE PI/2  // max steering angle. This only applies to Ackermann steering
