...
if(NOT "include;/usr/local/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_calib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/linorobot_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/linorobot_ws/install/lib;/home/nvidia/mrobot_v2/mrobot/devel/lib;/home/nvidia/velodyne16/devel/lib;/home/nvidia/rplidar/devel/lib;/home/nvidia/turbot/devel/lib;/home/nvidia/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
